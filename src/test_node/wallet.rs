...
impl BitcoinWalletClient {
    ...
    pub async fn addconnection(
        ...
        self.client
            .call::<AddconnectionResponse>("addconnection", &params)
            .await
    }
    ...
    pub async fn addpeeraddress(
        ...
        self.client
            .call::<AddpeeraddressResponse>("addpeeraddress", &params)
            .await
    }
    ...
    pub async fn combinepsbt(
        ...
        self.client
            .call::<CombinepsbtResponse>("combinepsbt", &params)
            .await
    }
    ...
    pub async fn combinerawtransaction(
        ...
        self.client
            .call::<CombinerawtransactionResponse>("combinerawtransaction", &params)
            .await
    }
    ...
    pub async fn converttopsbt(
        ...
        self.client
            .call::<ConverttopsbtResponse>("converttopsbt", &params)
            .await
    }
    ...
    pub async fn createmultisig(
        ...
        self.client
            .call::<CreatemultisigResponse>("createmultisig", &params)
            .await
    }
    ...
    pub async fn createpsbt(
        ...
        self.client
            .call::<CreatepsbtResponse>("createpsbt", &params)
            .await
    }
    ...
    pub async fn decodepsbt(&self, psbt: String) -> Result<DecodepsbtResponse, TransportError> {
        ...
        self.client
            .call::<DecodepsbtResponse>("decodepsbt", &params)
            .await
    }
    ...
    pub async fn decoderawtransaction(
        ...
        self.client
            .call::<DecoderawtransactionResponse>("decoderawtransaction", &params)
            .await
    }
    ...
    pub async fn decodescript(
        ...
        self.client
            .call::<DecodescriptResponse>("decodescript", &params)
            .await
    }
    ...
    pub async fn deriveaddresses(
        ...
        self.client
            .call::<DeriveaddressesResponse>("deriveaddresses", &params)
            .await
    }
    ...
    pub async fn descriptorprocesspsbt(
        ...
        self.client
            .call::<DescriptorprocesspsbtResponse>("descriptorprocesspsbt", &params)
            .await
    }
    ...
    pub async fn dumptxoutset(
        ...
        self.client
            .call::<DumptxoutsetResponse>("dumptxoutset", &params)
            .await
    }
    ...
    pub async fn echoipc(&self, arg: String) -> Result<EchoipcResponse, TransportError> {
        ...
        self.client
            .call::<EchoipcResponse>("echoipc", &params)
            .await
    }
    ...
    pub async fn echojson(
        ...
        self.client
            .call::<EchojsonResponse>("echojson", &params)
            .await
    }
    ...
    pub async fn enumeratesigners(&self) -> Result<EnumeratesignersResponse, TransportError> {
        ...
        self.client
            .call::<EnumeratesignersResponse>("enumeratesigners", &[])
            .await
    }
    ...
    pub async fn estimaterawfee(
        ...
        self.client
            .call::<EstimaterawfeeResponse>("estimaterawfee", &params)
            .await
    }
    ...
    pub async fn estimatesmartfee(
        ...
        self.client
            .call::<EstimatesmartfeeResponse>("estimatesmartfee", &params)
            .await
    }
    ...
    pub async fn finalizepsbt(
        ...
        self.client
            .call::<FinalizepsbtResponse>("finalizepsbt", &params)
            .await
    }
    ...
    pub async fn fundrawtransaction(
        ...
        self.client
            .call::<FundrawtransactionResponse>("fundrawtransaction", &params)
            .await
    }
    ...
    pub async fn generateblock(
        ...
        self.client
            .call::<GenerateblockResponse>("generateblock", &params)
            .await
    }
    ...
    pub async fn generatetoaddress(
        ...
        self.client
            .call::<GeneratetoaddressResponse>("generatetoaddress", &params)
            .await
    }
    ...
    pub async fn generatetodescriptor(
        ...
        self.client
            .call::<GeneratetodescriptorResponse>("generatetodescriptor", &params)
            .await
    }
    ...
    pub async fn getaddednodeinfo(
        ...
        self.client
            .call::<GetaddednodeinfoResponse>("getaddednodeinfo", &params)
            .await
    }
    ...
    pub async fn getbestblockhash(&self) -> Result<GetbestblockhashResponse, TransportError> {
        ...
        self.client
            .call::<GetbestblockhashResponse>("getbestblockhash", &[])
            .await
    }
    ...
    pub async fn getblock(
        ...
        self.client
            .call::<GetblockResponse>("getblock", &params)
            .await
    }
    ...
    pub async fn getblockchaininfo(&self) -> Result<GetblockchaininfoResponse, TransportError> {
        ...
        self.client
            .call::<GetblockchaininfoResponse>("getblockchaininfo", &[])
            .await
    }
    ...
    pub async fn getblockcount(&self) -> Result<GetblockcountResponse, TransportError> {
        ...
        self.client
            .call::<GetblockcountResponse>("getblockcount", &[])
            .await
    }
    ...
    pub async fn getblockfilter(
        ...
        self.client
            .call::<GetblockfilterResponse>("getblockfilter", &params)
            .await
    }
    ...
    pub async fn getblockfrompeer(
        ...
        self.client
            .call::<GetblockfrompeerResponse>("getblockfrompeer", &params)
            .await
    }
    ...
    pub async fn getblockhash(&self, height: u64) -> Result<GetblockhashResponse, TransportError> {
        ...
        self.client
            .call::<GetblockhashResponse>("getblockhash", &params)
            .await
    }
    ...
    pub async fn getblockheader(
        ...
        self.client
            .call::<GetblockheaderResponse>("getblockheader", &params)
            .await
    }
    ...
    pub async fn getblockstats(
        ...
        self.client
            .call::<GetblockstatsResponse>("getblockstats", &params)
            .await
    }
    ...
    pub async fn getchainstates(&self) -> Result<GetchainstatesResponse, TransportError> {
        ...
        self.client
            .call::<GetchainstatesResponse>("getchainstates", &[])
            .await
    }
    ...
    pub async fn getchaintips(&self) -> Result<GetchaintipsResponse, TransportError> {
        ...
        self.client
            .call::<GetchaintipsResponse>("getchaintips", &[])
            .await
    }
    ...
    pub async fn getchaintxstats(
        ...
        self.client
            .call::<GetchaintxstatsResponse>("getchaintxstats", &params)
            .await
    }
    ...
    pub async fn getconnectioncount(&self) -> Result<GetconnectioncountResponse, TransportError> {
        ...
        self.client
            .call::<GetconnectioncountResponse>("getconnectioncount", &[])
            .await
    }
    ...
    pub async fn getdeploymentinfo(
        ...
        self.client
            .call::<GetdeploymentinfoResponse>("getdeploymentinfo", &params)
            .await
    }
    ...
    pub async fn getdescriptoractivity(
        ...
        self.client
            .call::<GetdescriptoractivityResponse>("getdescriptoractivity", &params)
            .await
    }
    ...
    pub async fn getdescriptorinfo(
        ...
        self.client
            .call::<GetdescriptorinfoResponse>("getdescriptorinfo", &params)
            .await
    }
    ...
    pub async fn getindexinfo(
        ...
        self.client
            .call::<GetindexinfoResponse>("getindexinfo", &params)
            .await
    }
    ...
    pub async fn getmemoryinfo(
        ...
        self.client
            .call::<GetmemoryinfoResponse>("getmemoryinfo", &params)
            .await
    }
    ...
    pub async fn getmempoolancestors(
        ...
        self.client
            .call::<GetmempoolancestorsResponse>("getmempoolancestors", &params)
            .await
    }
    ...
    pub async fn getmempooldescendants(
        ...
        self.client
            .call::<GetmempooldescendantsResponse>("getmempooldescendants", &params)
            .await
    }
    ...
    pub async fn getmempoolentry(
        ...
        self.client
            .call::<GetmempoolentryResponse>("getmempoolentry", &params)
            .await
    }
    ...
    pub async fn getmempoolinfo(&self) -> Result<GetmempoolinfoResponse, TransportError> {
        ...
        self.client
            .call::<GetmempoolinfoResponse>("getmempoolinfo", &[])
            .await
    }
    ...
    pub async fn getmininginfo(&self) -> Result<GetmininginfoResponse, TransportError> {
        ...
        self.client
            .call::<GetmininginfoResponse>("getmininginfo", &[])
            .await
    }
    ...
    pub async fn getnettotals(&self) -> Result<GetnettotalsResponse, TransportError> {
        ...
        self.client
            .call::<GetnettotalsResponse>("getnettotals", &[])
            .await
    }
    ...
    pub async fn getnetworkhashps(
        ...
        self.client
            .call::<GetnetworkhashpsResponse>("getnetworkhashps", &params)
            .await
    }
    ...
    pub async fn getnetworkinfo(&self) -> Result<GetnetworkinfoResponse, TransportError> {
        ...
        self.client
            .call::<GetnetworkinfoResponse>("getnetworkinfo", &[])
            .await
    }
    ...
    pub async fn getnodeaddresses(
        ...
        self.client
            .call::<GetnodeaddressesResponse>("getnodeaddresses", &params)
            .await
    }
    ...
    pub async fn getorphantxs(
        ...
        self.client
            .call::<GetorphantxsResponse>("getorphantxs", &params)
            .await
    }
    ...
    pub async fn getpeerinfo(&self) -> Result<GetpeerinfoResponse, TransportError> {
        ...
        self.client
            .call::<GetpeerinfoResponse>("getpeerinfo", &[])
            .await
    }
    ...
    pub async fn getprioritisedtransactions(
        ...
        self.client
            .call::<GetprioritisedtransactionsResponse>("getprioritisedtransactions", &[])
            .await
    }
    ...
    pub async fn getrawaddrman(&self) -> Result<GetrawaddrmanResponse, TransportError> {
        ...
        self.client
            .call::<GetrawaddrmanResponse>("getrawaddrman", &[])
            .await
    }
    ...
    pub async fn getrawmempool(
        ...
        self.client
            .call::<GetrawmempoolResponse>("getrawmempool", &params)
            .await
    }
    ...
    pub async fn getrawtransaction(
        ...
        self.client
            .call::<GetrawtransactionResponse>("getrawtransaction", &params)
            .await
    }
    ...
    pub async fn gettxoutproof(
        ...
        self.client
            .call::<GettxoutproofResponse>("gettxoutproof", &params)
            .await
    }
    ...
    pub async fn gettxoutsetinfo(
        ...
        self.client
            .call::<GettxoutsetinfoResponse>("gettxoutsetinfo", &params)
            .await
    }
    ...
    pub async fn gettxspendingprevout(
        ...
        self.client
            .call::<GettxspendingprevoutResponse>("gettxspendingprevout", &params)
            .await
    }
    ...
    pub async fn getzmqnotifications(&self) -> Result<GetzmqnotificationsResponse, TransportError> {
        ...
        self.client
            .call::<GetzmqnotificationsResponse>("getzmqnotifications", &[])
            .await
    }
    ...
    pub async fn joinpsbts(
        ...
        self.client
            .call::<JoinpsbtsResponse>("joinpsbts", &params)
            .await
    }
    ...
    pub async fn prioritisetransaction(
        ...
        self.client
            .call::<PrioritisetransactionResponse>("prioritisetransaction", &params)
            .await
    }
    ...
    pub async fn pruneblockchain(
        ...
        self.client
            .call::<PruneblockchainResponse>("pruneblockchain", &params)
            .await
    }
    ...
    pub async fn savemempool(&self) -> Result<SavemempoolResponse, TransportError> {
        ...
        self.client
            .call::<SavemempoolResponse>("savemempool", &[])
            .await
    }
    ...
    pub async fn scantxoutset(
        ...
        self.client
            .call::<ScantxoutsetResponse>("scantxoutset", &params)
            .await
    }
    ...
    pub async fn sendmsgtopeer(
        ...
        self.client
            .call::<SendmsgtopeerResponse>("sendmsgtopeer", &params)
            .await
    }
    ...
    pub async fn sendrawtransaction(
        ...
        self.client
            .call::<SendrawtransactionResponse>("sendrawtransaction", &params)
            .await
    }
    ...
    pub async fn signmessagewithprivkey(
        ...
        self.client
            .call::<SignmessagewithprivkeyResponse>("signmessagewithprivkey", &params)
            .await
    }
    ...
    pub async fn submitpackage(
        ...
        self.client
            .call::<SubmitpackageResponse>("submitpackage", &params)
            .await
    }
    ...
    pub async fn utxoupdatepsbt(
        ...
        self.client
            .call::<UtxoupdatepsbtResponse>("utxoupdatepsbt", &params)
            .await
    }
    ...
    pub async fn validateaddress(
        ...
        self.client
            .call::<ValidateaddressResponse>("validateaddress", &params)
            .await
    }
    ...
    pub async fn verifychain(
        ...
        self.client
            .call::<VerifychainResponse>("verifychain", &params)
            .await
    }
    ...
    pub async fn verifymessage(
        ...
        self.client
            .call::<VerifymessageResponse>("verifymessage", &params)
            .await
    }
    ...
    pub async fn verifytxoutproof(
        ...
        self.client
            .call::<VerifytxoutproofResponse>("verifytxoutproof", &params)
            .await
    }
    ...
    pub async fn waitforblock(
        ...
        self.client
            .call::<WaitforblockResponse>("waitforblock", &params)
            .await
    }
    ...
    pub async fn waitforblockheight(
        ...
        self.client
            .call::<WaitforblockheightResponse>("waitforblockheight", &params)
            .await
    }
