...
pub async fn sendmsgtopeer(transport: &dyn TransportTrait, peer_id: serde_json::Value, msg_type: serde_json::Value, msg: serde_json::Value) -> Result<SendmsgtopeerResponse, TransportError> {
