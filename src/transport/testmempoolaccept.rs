...
pub async fn testmempoolaccept(transport: &dyn Transport, rawtxs: serde_json::Value, maxfeerate: serde_json::Value) -> Result<TestmempoolacceptResponse, TransportError> {
