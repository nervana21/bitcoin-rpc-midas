...
pub async fn estimaterawfee(transport: &dyn TransportTrait, conf_target: serde_json::Value, threshold: serde_json::Value) -> Result<EstimaterawfeeResponse, TransportError> {
