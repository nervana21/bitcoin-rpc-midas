...
pub async fn createwalletdescriptor(transport: &dyn TransportTrait, r#type: serde_json::Value, options: serde_json::Value) -> Result<CreatewalletdescriptorResponse, TransportError> {
