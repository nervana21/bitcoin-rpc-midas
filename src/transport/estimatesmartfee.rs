...
pub async fn estimatesmartfee(transport: &dyn TransportTrait, conf_target: serde_json::Value, estimate_mode: serde_json::Value) -> Result<EstimatesmartfeeResponse, TransportError> {
