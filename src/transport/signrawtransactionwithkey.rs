...
pub async fn signrawtransactionwithkey(transport: &dyn Transport, hexstring: serde_json::Value, privkeys: serde_json::Value, prevtxs: serde_json::Value, sighashtype: serde_json::Value) -> Result<SignrawtransactionwithkeyResponse, TransportError> {
