...
/// # Example
/// ```rust
/// use bitcoin_rpc_codegen::client::latest::signrawtransactionwithkey;
///
...
pub async fn signrawtransactionwithkey(transport: &dyn TransportTrait, hexstring: serde_json::Value, privkeys: serde_json::Value, prevtxs: serde_json::Value, sighashtype: serde_json::Value) -> Result<SignrawtransactionwithkeyResponse, TransportError> {
