...
pub async fn getrawtransaction(transport: &dyn TransportTrait, txid: serde_json::Value, verbosity: serde_json::Value, blockhash: serde_json::Value) -> Result<GetrawtransactionResponse, TransportError> {
