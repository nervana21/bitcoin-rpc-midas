...
pub async fn submitpackage(transport: &dyn TransportTrait, package: serde_json::Value, maxfeerate: serde_json::Value, maxburnamount: serde_json::Value) -> Result<SubmitpackageResponse, TransportError> {
