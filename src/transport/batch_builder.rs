...
impl BatchBuilder {
    ...
    pub fn addconnection(mut self, address: Value, connection_type: Value, v2transport: Value) -> Self {
        self.calls.push(("addconnection", vec![json!(address), json!(connection_type), json!(v2transport)]));
        self
    }
    ...
    pub fn converttopsbt(mut self, hexstring: Value, permitsigdata: Value, iswitness: Value) -> Self {
        self.calls.push(("converttopsbt", vec![json!(hexstring), json!(permitsigdata), json!(iswitness)]));
        self
    }

    /// Queue a `createmultisig` RPC call
    pub fn createmultisig(mut self, nrequired: Value, keys: Value, address_type: Value) -> Self {
        self.calls.push(("createmultisig", vec![json!(nrequired), json!(keys), json!(address_type)]));
        self
    }

    /// Queue a `createpsbt` RPC call
    pub fn createpsbt(mut self, inputs: Value, outputs: Value, locktime: Value, replaceable: Value) -> Self {
        self.calls.push(("createpsbt", vec![json!(inputs), json!(outputs), json!(locktime), json!(replaceable)]));
        self
    }

    /// Queue a `createrawtransaction` RPC call
    pub fn createrawtransaction(mut self, inputs: Value, outputs: Value, locktime: Value, replaceable: Value) -> Self {
        self.calls.push(("createrawtransaction", vec![json!(inputs), json!(outputs), json!(locktime), json!(replaceable)]));
        self
    }

    /// Queue a `createwallet` RPC call
    pub fn createwallet(mut self, wallet_name: Value, disable_private_keys: Value, blank: Value, passphrase: Value, avoid_reuse: Value, descriptors: Value, load_on_startup: Value, external_signer: Value) -> Self {
        self.calls.push(("createwallet", vec![json!(wallet_name), json!(disable_private_keys), json!(blank), json!(passphrase), json!(avoid_reuse), json!(descriptors), json!(load_on_startup), json!(external_signer)]));
        self
    }
    ...
    pub fn descriptorprocesspsbt(mut self, psbt: Value, descriptors: Value, sighashtype: Value, bip32derivs: Value, finalize: Value) -> Self {
        self.calls.push(("descriptorprocesspsbt", vec![json!(psbt), json!(descriptors), json!(sighashtype), json!(bip32derivs), json!(finalize)]));
        self
    }
    ...
    pub fn echo(mut self, arg0: Value, arg1: Value, arg2: Value, arg3: Value, arg4: Value, arg5: Value, arg6: Value, arg7: Value, arg8: Value, arg9: Value) -> Self {
        self.calls.push(("echo", vec![json!(arg0), json!(arg1), json!(arg2), json!(arg3), json!(arg4), json!(arg5), json!(arg6), json!(arg7), json!(arg8), json!(arg9)]));
        self
    }
    ...
    pub fn echojson(mut self, arg0: Value, arg1: Value, arg2: Value, arg3: Value, arg4: Value, arg5: Value, arg6: Value, arg7: Value, arg8: Value, arg9: Value) -> Self {
        self.calls.push(("echojson", vec![json!(arg0), json!(arg1), json!(arg2), json!(arg3), json!(arg4), json!(arg5), json!(arg6), json!(arg7), json!(arg8), json!(arg9)]));
        self
    }
    ...
    pub fn fundrawtransaction(mut self, hexstring: Value, options: Value, iswitness: Value) -> Self {
        self.calls.push(("fundrawtransaction", vec![json!(hexstring), json!(options), json!(iswitness)]));
        self
    }
    ...
    pub fn generatetoaddress(mut self, nblocks: Value, address: Value, maxtries: Value) -> Self {
        self.calls.push(("generatetoaddress", vec![json!(nblocks), json!(address), json!(maxtries)]));
        self
    }

    /// Queue a `generatetodescriptor` RPC call
    pub fn generatetodescriptor(mut self, num_blocks: Value, descriptor: Value, maxtries: Value) -> Self {
        self.calls.push(("generatetodescriptor", vec![json!(num_blocks), json!(descriptor), json!(maxtries)]));
        self
    }
    ...
    pub fn getbalance(mut self, dummy: Value, minconf: Value, include_watchonly: Value, avoid_reuse: Value) -> Self {
        self.calls.push(("getbalance", vec![json!(dummy), json!(minconf), json!(include_watchonly), json!(avoid_reuse)]));
        self
    }
    ...
    pub fn getrawtransaction(mut self, txid: Value, verbosity: Value, blockhash: Value) -> Self {
        self.calls.push(("getrawtransaction", vec![json!(txid), json!(verbosity), json!(blockhash)]));
        self
    }

    /// Queue a `getreceivedbyaddress` RPC call
    pub fn getreceivedbyaddress(mut self, address: Value, minconf: Value, include_immature_coinbase: Value) -> Self {
        self.calls.push(("getreceivedbyaddress", vec![json!(address), json!(minconf), json!(include_immature_coinbase)]));
        self
    }

    /// Queue a `getreceivedbylabel` RPC call
    pub fn getreceivedbylabel(mut self, label: Value, minconf: Value, include_immature_coinbase: Value) -> Self {
        self.calls.push(("getreceivedbylabel", vec![json!(label), json!(minconf), json!(include_immature_coinbase)]));
        self
    }
    ...
    pub fn gettransaction(mut self, txid: Value, include_watchonly: Value, verbose: Value) -> Self {
        self.calls.push(("gettransaction", vec![json!(txid), json!(include_watchonly), json!(verbose)]));
        self
    }
    ...
    pub fn gettxoutsetinfo(mut self, hash_type: Value, hash_or_height: Value, use_index: Value) -> Self {
        self.calls.push(("gettxoutsetinfo", vec![json!(hash_type), json!(hash_or_height), json!(use_index)]));
        self
    }
    ...
    pub fn listreceivedbyaddress(mut self, minconf: Value, include_empty: Value, include_watchonly: Value, address_filter: Value, include_immature_coinbase: Value) -> Self {
        self.calls.push(("listreceivedbyaddress", vec![json!(minconf), json!(include_empty), json!(include_watchonly), json!(address_filter), json!(include_immature_coinbase)]));
        self
    }

    /// Queue a `listreceivedbylabel` RPC call
    pub fn listreceivedbylabel(mut self, minconf: Value, include_empty: Value, include_watchonly: Value, include_immature_coinbase: Value) -> Self {
        self.calls.push(("listreceivedbylabel", vec![json!(minconf), json!(include_empty), json!(include_watchonly), json!(include_immature_coinbase)]));
        self
    }

    /// Queue a `listsinceblock` RPC call
    pub fn listsinceblock(mut self, blockhash: Value, target_confirmations: Value, include_watchonly: Value, include_removed: Value, include_change: Value, label: Value) -> Self {
        self.calls.push(("listsinceblock", vec![json!(blockhash), json!(target_confirmations), json!(include_watchonly), json!(include_removed), json!(include_change), json!(label)]));
        self
    }

    /// Queue a `listtransactions` RPC call
    pub fn listtransactions(mut self, label: Value, count: Value, skip: Value, include_watchonly: Value) -> Self {
        self.calls.push(("listtransactions", vec![json!(label), json!(count), json!(skip), json!(include_watchonly)]));
        self
    }

    /// Queue a `listunspent` RPC call
    pub fn listunspent(mut self, minconf: Value, maxconf: Value, addresses: Value, include_unsafe: Value, query_options: Value) -> Self {
        self.calls.push(("listunspent", vec![json!(minconf), json!(maxconf), json!(addresses), json!(include_unsafe), json!(query_options)]));
        self
    }
    ...
    pub fn lockunspent(mut self, unlock: Value, transactions: Value, persistent: Value) -> Self {
        self.calls.push(("lockunspent", vec![json!(unlock), json!(transactions), json!(persistent)]));
        self
    }
    ...
    pub fn prioritisetransaction(mut self, txid: Value, dummy: Value, fee_delta: Value) -> Self {
        self.calls.push(("prioritisetransaction", vec![json!(txid), json!(dummy), json!(fee_delta)]));
        self
    }
    ...
    pub fn restorewallet(mut self, wallet_name: Value, backup_file: Value, load_on_startup: Value) -> Self {
        self.calls.push(("restorewallet", vec![json!(wallet_name), json!(backup_file), json!(load_on_startup)]));
        self
    }
    ...
    pub fn scanblocks(mut self, action: Value, scanobjects: Value, start_height: Value, stop_height: Value, filtertype: Value, options: Value) -> Self {
        self.calls.push(("scanblocks", vec![json!(action), json!(scanobjects), json!(start_height), json!(stop_height), json!(filtertype), json!(options)]));
        self
    }
    ...
    pub fn sendall(mut self, recipients: Value, conf_target: Value, estimate_mode: Value, fee_rate: Value, options: Value) -> Self {
        self.calls.push(("sendall", vec![json!(recipients), json!(conf_target), json!(estimate_mode), json!(fee_rate), json!(options)]));
        self
    }

    /// Queue a `sendmany` RPC call
    pub fn sendmany(mut self, dummy: Value, amounts: Value, minconf: Value, comment: Value, subtractfeefrom: Value, replaceable: Value, conf_target: Value, estimate_mode: Value, fee_rate: Value, verbose: Value) -> Self {
        self.calls.push(("sendmany", vec![json!(dummy), json!(amounts), json!(minconf), json!(comment), json!(subtractfeefrom), json!(replaceable), json!(conf_target), json!(estimate_mode), json!(fee_rate), json!(verbose)]));
        self
    }
    ...
    pub fn sendrawtransaction(mut self, hexstring: Value, maxfeerate: Value, maxburnamount: Value) -> Self {
        self.calls.push(("sendrawtransaction", vec![json!(hexstring), json!(maxfeerate), json!(maxburnamount)]));
        self
    }

    /// Queue a `sendtoaddress` RPC call
    pub fn sendtoaddress(mut self, address: Value, amount: Value, comment: Value, comment_to: Value, subtractfeefromamount: Value, replaceable: Value, conf_target: Value, estimate_mode: Value, avoid_reuse: Value, fee_rate: Value, verbose: Value) -> Self {
        self.calls.push(("sendtoaddress", vec![json!(address), json!(amount), json!(comment), json!(comment_to), json!(subtractfeefromamount), json!(replaceable), json!(conf_target), json!(estimate_mode), json!(avoid_reuse), json!(fee_rate), json!(verbose)]));
        self
    }
    ...
    pub fn signrawtransactionwithkey(mut self, hexstring: Value, privkeys: Value, prevtxs: Value, sighashtype: Value) -> Self {
        self.calls.push(("signrawtransactionwithkey", vec![json!(hexstring), json!(privkeys), json!(prevtxs), json!(sighashtype)]));
        self
    }

    /// Queue a `signrawtransactionwithwallet` RPC call
    pub fn signrawtransactionwithwallet(mut self, hexstring: Value, prevtxs: Value, sighashtype: Value) -> Self {
        self.calls.push(("signrawtransactionwithwallet", vec![json!(hexstring), json!(prevtxs), json!(sighashtype)]));
        self
    }
    ...
    pub fn submitpackage(mut self, package: Value, maxfeerate: Value, maxburnamount: Value) -> Self {
        self.calls.push(("submitpackage", vec![json!(package), json!(maxfeerate), json!(maxburnamount)]));
        self
    }
    ...
    pub fn walletcreatefundedpsbt(mut self, inputs: Value, outputs: Value, locktime: Value, options: Value, bip32derivs: Value) -> Self {
        self.calls.push(("walletcreatefundedpsbt", vec![json!(inputs), json!(outputs), json!(locktime), json!(options), json!(bip32derivs)]));
        self
    }
    ...
    pub fn walletpassphrasechange(mut self, oldpassphrase: Value, newpassphrase: Value) -> Self {
        self.calls.push(("walletpassphrasechange", vec![json!(oldpassphrase), json!(newpassphrase)]));
        self
    }

    /// Queue a `walletprocesspsbt` RPC call
    pub fn walletprocesspsbt(mut self, psbt: Value, sign: Value, sighashtype: Value, bip32derivs: Value, finalize: Value) -> Self {
        self.calls.push(("walletprocesspsbt", vec![json!(psbt), json!(sign), json!(sighashtype), json!(bip32derivs), json!(finalize)]));
        self
    }
    ...
    pub async fn execute(self) -> Result<BatchResults, TransportError> {
        ...
        for (i, (method_name, _)) in calls.iter().enumerate() {
            match *method_name {
                ...
                "combinepsbt" => results.combinepsbt = Some(serde_json::from_value::<CombinepsbtResponse>(raw_results[i].clone())?),
                "combinerawtransaction" => results.combinerawtransaction = Some(serde_json::from_value::<CombinerawtransactionResponse>(raw_results[i].clone())?),
                "converttopsbt" => results.converttopsbt = Some(serde_json::from_value::<ConverttopsbtResponse>(raw_results[i].clone())?),
                "createmultisig" => results.createmultisig = Some(serde_json::from_value::<CreatemultisigResponse>(raw_results[i].clone())?),
                "createpsbt" => results.createpsbt = Some(serde_json::from_value::<CreatepsbtResponse>(raw_results[i].clone())?),
                "createrawtransaction" => results.createrawtransaction = Some(serde_json::from_value::<CreaterawtransactionResponse>(raw_results[i].clone())?),
                "createwallet" => results.createwallet = Some(serde_json::from_value::<CreatewalletResponse>(raw_results[i].clone())?),
                "createwalletdescriptor" => results.createwalletdescriptor = Some(serde_json::from_value::<CreatewalletdescriptorResponse>(raw_results[i].clone())?),
                "decodepsbt" => results.decodepsbt = Some(serde_json::from_value::<DecodepsbtResponse>(raw_results[i].clone())?),
                "decoderawtransaction" => results.decoderawtransaction = Some(serde_json::from_value::<DecoderawtransactionResponse>(raw_results[i].clone())?),
                "decodescript" => results.decodescript = Some(serde_json::from_value::<DecodescriptResponse>(raw_results[i].clone())?),
                ...
                "encryptwallet" => results.encryptwallet = Some(serde_json::from_value::<EncryptwalletResponse>(raw_results[i].clone())?),
                "enumeratesigners" => results.enumeratesigners = Some(serde_json::from_value::<EnumeratesignersResponse>(raw_results[i].clone())?),
                "estimaterawfee" => results.estimaterawfee = Some(serde_json::from_value::<EstimaterawfeeResponse>(raw_results[i].clone())?),
                "estimatesmartfee" => results.estimatesmartfee = Some(serde_json::from_value::<EstimatesmartfeeResponse>(raw_results[i].clone())?),
                "finalizepsbt" => results.finalizepsbt = Some(serde_json::from_value::<FinalizepsbtResponse>(raw_results[i].clone())?),
                "fundrawtransaction" => results.fundrawtransaction = Some(serde_json::from_value::<FundrawtransactionResponse>(raw_results[i].clone())?),
                "generate" => results.generate = (),
                "generateblock" => results.generateblock = Some(serde_json::from_value::<GenerateblockResponse>(raw_results[i].clone())?),
                "generatetoaddress" => results.generatetoaddress = Some(serde_json::from_value::<GeneratetoaddressResponse>(raw_results[i].clone())?),
                "generatetodescriptor" => results.generatetodescriptor = Some(serde_json::from_value::<GeneratetodescriptorResponse>(raw_results[i].clone())?),
                "getaddednodeinfo" => results.getaddednodeinfo = Some(serde_json::from_value::<GetaddednodeinfoResponse>(raw_results[i].clone())?),
                "getaddressesbylabel" => results.getaddressesbylabel = Some(serde_json::from_value::<GetaddressesbylabelResponse>(raw_results[i].clone())?),
                "getaddressinfo" => results.getaddressinfo = Some(serde_json::from_value::<GetaddressinfoResponse>(raw_results[i].clone())?),
                "getaddrmaninfo" => results.getaddrmaninfo = Some(serde_json::from_value::<GetaddrmaninfoResponse>(raw_results[i].clone())?),
                "getbalance" => results.getbalance = Some(serde_json::from_value::<GetbalanceResponse>(raw_results[i].clone())?),
                "getbalances" => results.getbalances = Some(serde_json::from_value::<GetbalancesResponse>(raw_results[i].clone())?),
                "getbestblockhash" => results.getbestblockhash = Some(serde_json::from_value::<GetbestblockhashResponse>(raw_results[i].clone())?),
                "getblock" => results.getblock = Some(serde_json::from_value::<GetblockResponse>(raw_results[i].clone())?),
                "getblockchaininfo" => results.getblockchaininfo = Some(serde_json::from_value::<GetblockchaininfoResponse>(raw_results[i].clone())?),
                "getblockcount" => results.getblockcount = Some(serde_json::from_value::<GetblockcountResponse>(raw_results[i].clone())?),
                "getblockfilter" => results.getblockfilter = Some(serde_json::from_value::<GetblockfilterResponse>(raw_results[i].clone())?),
                "getblockfrompeer" => results.getblockfrompeer = Some(serde_json::from_value::<GetblockfrompeerResponse>(raw_results[i].clone())?),
                "getblockhash" => results.getblockhash = Some(serde_json::from_value::<GetblockhashResponse>(raw_results[i].clone())?),
                "getblockheader" => results.getblockheader = Some(serde_json::from_value::<GetblockheaderResponse>(raw_results[i].clone())?),
                "getblockstats" => results.getblockstats = Some(serde_json::from_value::<GetblockstatsResponse>(raw_results[i].clone())?),
                "getblocktemplate" => results.getblocktemplate = Some(serde_json::from_value::<GetblocktemplateResponse>(raw_results[i].clone())?),
                "getchainstates" => results.getchainstates = Some(serde_json::from_value::<GetchainstatesResponse>(raw_results[i].clone())?),
                "getchaintips" => results.getchaintips = Some(serde_json::from_value::<GetchaintipsResponse>(raw_results[i].clone())?),
                ...
                "getindexinfo" => results.getindexinfo = Some(serde_json::from_value::<GetindexinfoResponse>(raw_results[i].clone())?),
                "getmemoryinfo" => results.getmemoryinfo = Some(serde_json::from_value::<GetmemoryinfoResponse>(raw_results[i].clone())?),
                "getmempoolancestors" => results.getmempoolancestors = Some(serde_json::from_value::<GetmempoolancestorsResponse>(raw_results[i].clone())?),
                "getmempooldescendants" => results.getmempooldescendants = Some(serde_json::from_value::<GetmempooldescendantsResponse>(raw_results[i].clone())?),
                "getmempoolentry" => results.getmempoolentry = Some(serde_json::from_value::<GetmempoolentryResponse>(raw_results[i].clone())?),
                "getmempoolinfo" => results.getmempoolinfo = Some(serde_json::from_value::<GetmempoolinfoResponse>(raw_results[i].clone())?),
                "getmininginfo" => results.getmininginfo = Some(serde_json::from_value::<GetmininginfoResponse>(raw_results[i].clone())?),
                "getnettotals" => results.getnettotals = Some(serde_json::from_value::<GetnettotalsResponse>(raw_results[i].clone())?),
                "getnetworkhashps" => results.getnetworkhashps = Some(serde_json::from_value::<GetnetworkhashpsResponse>(raw_results[i].clone())?),
                "getnetworkinfo" => results.getnetworkinfo = Some(serde_json::from_value::<GetnetworkinfoResponse>(raw_results[i].clone())?),
                "getnewaddress" => results.getnewaddress = Some(serde_json::from_value::<GetnewaddressResponse>(raw_results[i].clone())?),
                "getnodeaddresses" => results.getnodeaddresses = Some(serde_json::from_value::<GetnodeaddressesResponse>(raw_results[i].clone())?),
                "getorphantxs" => results.getorphantxs = Some(serde_json::from_value::<GetorphantxsResponse>(raw_results[i].clone())?),
                "getpeerinfo" => results.getpeerinfo = Some(serde_json::from_value::<GetpeerinfoResponse>(raw_results[i].clone())?),
                "getprioritisedtransactions" => results.getprioritisedtransactions = Some(serde_json::from_value::<GetprioritisedtransactionsResponse>(raw_results[i].clone())?),
                "getrawaddrman" => results.getrawaddrman = Some(serde_json::from_value::<GetrawaddrmanResponse>(raw_results[i].clone())?),
                "getrawchangeaddress" => results.getrawchangeaddress = Some(serde_json::from_value::<GetrawchangeaddressResponse>(raw_results[i].clone())?),
                "getrawmempool" => results.getrawmempool = Some(serde_json::from_value::<GetrawmempoolResponse>(raw_results[i].clone())?),
                "getrawtransaction" => results.getrawtransaction = Some(serde_json::from_value::<GetrawtransactionResponse>(raw_results[i].clone())?),
                "getreceivedbyaddress" => results.getreceivedbyaddress = Some(serde_json::from_value::<GetreceivedbyaddressResponse>(raw_results[i].clone())?),
                "getreceivedbylabel" => results.getreceivedbylabel = Some(serde_json::from_value::<GetreceivedbylabelResponse>(raw_results[i].clone())?),
                "getrpcinfo" => results.getrpcinfo = Some(serde_json::from_value::<GetrpcinfoResponse>(raw_results[i].clone())?),
                "gettransaction" => results.gettransaction = Some(serde_json::from_value::<GettransactionResponse>(raw_results[i].clone())?),
                "gettxout" => results.gettxout = Some(serde_json::from_value::<GettxoutResponse>(raw_results[i].clone())?),
                ...
                "listaddressgroupings" => results.listaddressgroupings = Some(serde_json::from_value::<ListaddressgroupingsResponse>(raw_results[i].clone())?),
                "listbanned" => results.listbanned = Some(serde_json::from_value::<ListbannedResponse>(raw_results[i].clone())?),
                "listdescriptors" => results.listdescriptors = Some(serde_json::from_value::<ListdescriptorsResponse>(raw_results[i].clone())?),
                "listlabels" => results.listlabels = Some(serde_json::from_value::<ListlabelsResponse>(raw_results[i].clone())?),
                "listlockunspent" => results.listlockunspent = Some(serde_json::from_value::<ListlockunspentResponse>(raw_results[i].clone())?),
                "listreceivedbyaddress" => results.listreceivedbyaddress = Some(serde_json::from_value::<ListreceivedbyaddressResponse>(raw_results[i].clone())?),
                "listreceivedbylabel" => results.listreceivedbylabel = Some(serde_json::from_value::<ListreceivedbylabelResponse>(raw_results[i].clone())?),
                "listsinceblock" => results.listsinceblock = Some(serde_json::from_value::<ListsinceblockResponse>(raw_results[i].clone())?),
                "listtransactions" => results.listtransactions = Some(serde_json::from_value::<ListtransactionsResponse>(raw_results[i].clone())?),
                "listunspent" => results.listunspent = Some(serde_json::from_value::<ListunspentResponse>(raw_results[i].clone())?),
                "listwalletdir" => results.listwalletdir = Some(serde_json::from_value::<ListwalletdirResponse>(raw_results[i].clone())?),
                "listwallets" => results.listwallets = Some(serde_json::from_value::<ListwalletsResponse>(raw_results[i].clone())?),
                "loadtxoutset" => results.loadtxoutset = Some(serde_json::from_value::<LoadtxoutsetResponse>(raw_results[i].clone())?),
                "loadwallet" => results.loadwallet = Some(serde_json::from_value::<LoadwalletResponse>(raw_results[i].clone())?),
                "lockunspent" => results.lockunspent = Some(serde_json::from_value::<LockunspentResponse>(raw_results[i].clone())?),
                ...
                "pruneblockchain" => results.pruneblockchain = Some(serde_json::from_value::<PruneblockchainResponse>(raw_results[i].clone())?),
                "psbtbumpfee" => results.psbtbumpfee = Some(serde_json::from_value::<PsbtbumpfeeResponse>(raw_results[i].clone())?),
                "reconsiderblock" => results.reconsiderblock = (),
                "removeprunedfunds" => results.removeprunedfunds = (),
                "rescanblockchain" => results.rescanblockchain = Some(serde_json::from_value::<RescanblockchainResponse>(raw_results[i].clone())?),
                "restorewallet" => results.restorewallet = Some(serde_json::from_value::<RestorewalletResponse>(raw_results[i].clone())?),
                ...
                "sendmsgtopeer" => results.sendmsgtopeer = Some(serde_json::from_value::<SendmsgtopeerResponse>(raw_results[i].clone())?),
                ...
                "settxfee" => results.settxfee = Some(serde_json::from_value::<SettxfeeResponse>(raw_results[i].clone())?),
                "setwalletflag" => results.setwalletflag = Some(serde_json::from_value::<SetwalletflagResponse>(raw_results[i].clone())?),
                "signmessage" => results.signmessage = Some(serde_json::from_value::<SignmessageResponse>(raw_results[i].clone())?),
                "signmessagewithprivkey" => results.signmessagewithprivkey = Some(serde_json::from_value::<SignmessagewithprivkeyResponse>(raw_results[i].clone())?),
                "signrawtransactionwithkey" => results.signrawtransactionwithkey = Some(serde_json::from_value::<SignrawtransactionwithkeyResponse>(raw_results[i].clone())?),
                "signrawtransactionwithwallet" => results.signrawtransactionwithwallet = Some(serde_json::from_value::<SignrawtransactionwithwalletResponse>(raw_results[i].clone())?),
                "simulaterawtransaction" => results.simulaterawtransaction = Some(serde_json::from_value::<SimulaterawtransactionResponse>(raw_results[i].clone())?),
                "stop" => results.stop = Some(serde_json::from_value::<StopResponse>(raw_results[i].clone())?),
                "submitblock" => results.submitblock = Some(serde_json::from_value::<SubmitblockResponse>(raw_results[i].clone())?),
                "submitheader" => results.submitheader = (),
                "submitpackage" => results.submitpackage = Some(serde_json::from_value::<SubmitpackageResponse>(raw_results[i].clone())?),
                ...
                "verifychain" => results.verifychain = Some(serde_json::from_value::<VerifychainResponse>(raw_results[i].clone())?),
                "verifymessage" => results.verifymessage = Some(serde_json::from_value::<VerifymessageResponse>(raw_results[i].clone())?),
                "verifytxoutproof" => results.verifytxoutproof = Some(serde_json::from_value::<VerifytxoutproofResponse>(raw_results[i].clone())?),
                "waitforblock" => results.waitforblock = Some(serde_json::from_value::<WaitforblockResponse>(raw_results[i].clone())?),
                "waitforblockheight" => results.waitforblockheight = Some(serde_json::from_value::<WaitforblockheightResponse>(raw_results[i].clone())?),
                "waitfornewblock" => results.waitfornewblock = Some(serde_json::from_value::<WaitfornewblockResponse>(raw_results[i].clone())?),
                "walletcreatefundedpsbt" => results.walletcreatefundedpsbt = Some(serde_json::from_value::<WalletcreatefundedpsbtResponse>(raw_results[i].clone())?),
                "walletdisplayaddress" => results.walletdisplayaddress = Some(serde_json::from_value::<WalletdisplayaddressResponse>(raw_results[i].clone())?),
                ...
                "walletprocesspsbt" => results.walletprocesspsbt = Some(serde_json::from_value::<WalletprocesspsbtResponse>(raw_results[i].clone())?),
