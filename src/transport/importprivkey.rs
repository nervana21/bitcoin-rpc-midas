...
pub async fn importprivkey(transport: &dyn Transport, privkey: serde_json::Value, label: serde_json::Value, rescan: serde_json::Value) -> Result<Value, TransportError> {
