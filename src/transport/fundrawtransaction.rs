...
pub async fn fundrawtransaction(transport: &dyn Transport, hexstring: serde_json::Value, options: serde_json::Value, iswitness: serde_json::Value) -> Result<FundrawtransactionResponse, TransportError> {
