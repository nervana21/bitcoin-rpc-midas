...
pub async fn restorewallet(transport: &dyn TransportTrait, wallet_name: serde_json::Value, backup_file: serde_json::Value, load_on_startup: serde_json::Value) -> Result<RestorewalletResponse, TransportError> {
