...
pub async fn generateblock(transport: &dyn Transport, output: serde_json::Value, transactions: serde_json::Value, submit: serde_json::Value) -> Result<GenerateblockResponse, TransportError> {
