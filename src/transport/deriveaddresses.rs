...
pub async fn deriveaddresses(transport: &dyn TransportTrait, descriptor: serde_json::Value, range: serde_json::Value) -> Result<DeriveaddressesResponse, TransportError> {
