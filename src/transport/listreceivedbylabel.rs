...
pub async fn listreceivedbylabel(transport: &dyn Transport, minconf: serde_json::Value, include_empty: serde_json::Value, include_watchonly: serde_json::Value, include_immature_coinbase: serde_json::Value) -> Result<ListreceivedbylabelResponse, TransportError> {
