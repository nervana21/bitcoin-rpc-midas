...
pub async fn loadwallet(transport: &dyn TransportTrait, filename: serde_json::Value, load_on_startup: serde_json::Value) -> Result<LoadwalletResponse, TransportError> {
