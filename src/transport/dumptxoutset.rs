...
pub async fn dumptxoutset(transport: &dyn TransportTrait, path: serde_json::Value, r#type: serde_json::Value, options: serde_json::Value) -> Result<DumptxoutsetResponse, TransportError> {
