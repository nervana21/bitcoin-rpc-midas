...
pub async fn sendrawtransaction(transport: &dyn TransportTrait, hexstring: serde_json::Value, maxfeerate: serde_json::Value, maxburnamount: serde_json::Value) -> Result<SendrawtransactionResponse, TransportError> {
