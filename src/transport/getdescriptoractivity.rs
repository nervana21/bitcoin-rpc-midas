...
/// # Example
/// ```rust
/// use bitcoin_rpc_codegen::client::latest::getdescriptoractivity;
///
...
pub async fn getdescriptoractivity(transport: &dyn TransportTrait, blockhashes: serde_json::Value, scanobjects: serde_json::Value, include_mempool: serde_json::Value) -> Result<GetdescriptoractivityResponse, TransportError> {
