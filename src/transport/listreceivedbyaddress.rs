...
pub async fn listreceivedbyaddress(transport: &dyn TransportTrait, minconf: serde_json::Value, include_empty: serde_json::Value, include_watchonly: serde_json::Value, address_filter: serde_json::Value, include_immature_coinbase: serde_json::Value) -> Result<ListreceivedbyaddressResponse, TransportError> {
