...
pub async fn sendmany(transport: &dyn TransportTrait, dummy: serde_json::Value, amounts: serde_json::Value, minconf: serde_json::Value, comment: serde_json::Value, subtractfeefrom: serde_json::Value, replaceable: serde_json::Value, conf_target: serde_json::Value, estimate_mode: serde_json::Value, fee_rate: serde_json::Value, verbose: serde_json::Value) -> Result<SendmanyResponse, TransportError> {
