...
#[doc = r#"A versioned client trait for Bitcoin Core v0.1.2"#]
#[async_trait]
pub trait BitcoinClientV012: Send + Sync + TransportTrait + TransportExt + RpcDispatchExt {
    ...
    async fn addconnection(&self, _address: String, _connection_type: String, _v2transport: bool) -> Result<AddconnectionResponse, TransportError> {
        let params = vec![
    ...
    async fn addmultisigaddress(&self, _nrequired: f64, _keys: Vec<serde_json::Value>, _label: Option<String>, _address_type: Option<String>) -> Result<AddmultisigaddressResponse, TransportError> {
        let params = vec![
        ...
        self.dispatch_json::<AddmultisigaddressResponse>("addmultisigaddress", &params).await
    }
    ...
    async fn addnode(&self, _node: String, _command: String, _v2transport: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
    ...
    async fn addpeeraddress(&self, _address: String, _port: f64, _tried: Option<bool>) -> Result<AddpeeraddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
    ...
    async fn api(&self) -> Result<ApiResponse, TransportError> {
        let params = vec![

        ];
        self.dispatch_json::<ApiResponse>("api", &params).await
    }

    /// Safely copies the current wallet file to the specified destination, which can either be a directory or a path with a filename.
    async fn backupwallet(&self, _destination: String) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_destination),
        ];
    ...
    async fn bumpfee(&self, _txid: bitcoin::Txid, _options: Option<serde_json::Value>) -> Result<BumpfeeResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
    ...
    async fn combinepsbt(&self, _txs: Vec<serde_json::Value>) -> Result<CombinepsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txs),
        ];
    ...
    async fn combinerawtransaction(&self, _txs: Vec<serde_json::Value>) -> Result<CombinerawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txs),
        ];
    ...
    async fn converttopsbt(&self, _hexstring: String, _permitsigdata: Option<bool>, _iswitness: Option<bool>) -> Result<ConverttopsbtResponse, TransportError> {
        let params = vec![
    ...
    async fn createmultisig(&self, _nrequired: f64, _keys: Vec<serde_json::Value>, _address_type: Option<String>) -> Result<CreatemultisigResponse, TransportError> {
        let params = vec![
            serde_json::json!(_nrequired),
            serde_json::json!(_keys),
            serde_json::json!(_address_type),
    ...
    async fn createpsbt(&self, _inputs: Vec<serde_json::Value>, _outputs: Vec<serde_json::Value>, _locktime: Option<u64>, _replaceable: Option<bool>) -> Result<CreatepsbtResponse, TransportError> {
        let params = vec![
    ...
    async fn createrawtransaction(&self, _inputs: Vec<serde_json::Value>, _outputs: Vec<serde_json::Value>, _locktime: Option<u64>, _replaceable: Option<bool>) -> Result<CreaterawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_inputs),
            serde_json::json!(_outputs),
            serde_json::json!(_locktime),
    ...
    async fn createwallet(&self, _wallet_name: String, _disable_private_keys: Option<bool>, _blank: Option<bool>, _passphrase: Option<String>, _avoid_reuse: Option<bool>, _descriptors: Option<bool>, _load_on_startup: Option<bool>, _external_signer: Option<bool>) -> Result<CreatewalletResponse, TransportError> {
        let params = vec![
    ...
    async fn createwalletdescriptor(&self, r#_type: String, _options: Option<serde_json::Value>) -> Result<CreatewalletdescriptorResponse, TransportError> {
        let params = vec![
            serde_json::json!(r#_type),
            serde_json::json!(_options),
        ];
        self.dispatch_json::<CreatewalletdescriptorResponse>("createwalletdescriptor", &params).await
    }
    ...
    async fn decoderawtransaction(&self, _hexstring: String, _iswitness: Option<bool>) -> Result<DecoderawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
            serde_json::json!(_iswitness),
        ];
    ...
    async fn decodescript(&self, _hexstring: String) -> Result<DecodescriptResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
        ];
    ...
    async fn deriveaddresses(&self, _descriptor: String, _range: Option<serde_json::Value>) -> Result<DeriveaddressesResponse, TransportError> {
        let params = vec![
            serde_json::json!(_descriptor),
            serde_json::json!(_range),
        ];
    ...
    async fn descriptorprocesspsbt(&self, _psbt: String, _descriptors: Vec<serde_json::Value>, _sighashtype: Option<String>, _bip32derivs: Option<bool>, _finalize: Option<bool>) -> Result<DescriptorprocesspsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_psbt),
            serde_json::json!(_descriptors),
    ...
    async fn disconnectnode(&self, _address: Option<String>, _nodeid: Option<f64>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_address),
            serde_json::json!(_nodeid),
        ];
    ...
    /// Note: This command is only compatible with legacy wallets.
    async fn dumpprivkey(&self, _address: String) -> Result<DumpprivkeyResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
        ];
        self.dispatch_json::<DumpprivkeyResponse>("dumpprivkey", &params).await
    }
    ...
    async fn dumptxoutset(&self, _path: String, r#_type: Option<String>, _options: Option<serde_json::Value>) -> Result<DumptxoutsetResponse, TransportError> {
        let params = vec![
    ...
    /// Note: This command is only compatible with legacy wallets.
    async fn dumpwallet(&self, _filename: String) -> Result<DumpwalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_filename),
        ];
        self.dispatch_json::<DumpwalletResponse>("dumpwallet", &params).await
    }
    ...
    async fn echo(&self, _arg0: Option<String>, _arg1: Option<String>, _arg2: Option<String>, _arg3: Option<String>, _arg4: Option<String>, _arg5: Option<String>, _arg6: Option<String>, _arg7: Option<String>, _arg8: Option<String>, _arg9: Option<String>) -> Result<EchoResponse, TransportError> {
        let params = vec![
    ...
    /// 
    /// The difference between echo and echojson is that echojson has argument conversion enabled in the client-side table in bitcoin-cli and the GUI. There is no server-side difference.
    async fn echojson(&self, _arg0: Option<String>, _arg1: Option<String>, _arg2: Option<String>, _arg3: Option<String>, _arg4: Option<String>, _arg5: Option<String>, _arg6: Option<String>, _arg7: Option<String>, _arg8: Option<String>, _arg9: Option<String>) -> Result<EchojsonResponse, TransportError> {
        let params = vec![
            serde_json::json!(_arg0),
            serde_json::json!(_arg1),
            serde_json::json!(_arg2),
    ...
    async fn encryptwallet(&self, _passphrase: String) -> Result<EncryptwalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_passphrase),
        ];
    ...
    async fn estimaterawfee(&self, _conf_target: u64, _threshold: Option<f64>) -> Result<EstimaterawfeeResponse, TransportError> {
        let params = vec![
    ...
    async fn estimatesmartfee(&self, _conf_target: u64, _estimate_mode: Option<String>) -> Result<EstimatesmartfeeResponse, TransportError> {
        let params = vec![
            serde_json::json!(_conf_target),
    ...
    async fn finalizepsbt(&self, _psbt: String, _extract: Option<bool>) -> Result<FinalizepsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_psbt),
            serde_json::json!(_extract),
        ];
    ...
    async fn fundrawtransaction(&self, _hexstring: String, _options: Option<serde_json::Value>, _iswitness: Option<bool>) -> Result<FundrawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
            serde_json::json!(_options),
            serde_json::json!(_iswitness),
    ...
    async fn generateblock(&self, _output: String, _transactions: Vec<serde_json::Value>, _submit: Option<bool>) -> Result<GenerateblockResponse, TransportError> {
        let params = vec![
    ...
    async fn generatetoaddress(&self, _nblocks: u64, _address: String, _maxtries: Option<u64>) -> Result<GeneratetoaddressResponse, TransportError> {
        let params = vec![
    ...
    async fn generatetodescriptor(&self, _num_blocks: u64, _descriptor: String, _maxtries: Option<u64>) -> Result<GeneratetodescriptorResponse, TransportError> {
        let params = vec![
    ...
    async fn getaddednodeinfo(&self, _node: Option<String>) -> Result<GetaddednodeinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_node),
        ];
    ...
    async fn getaddressesbylabel(&self, _label: String) -> Result<GetaddressesbylabelResponse, TransportError> {
        let params = vec![
            serde_json::json!(_label),
        ];
    ...
    async fn getaddressinfo(&self, _address: String) -> Result<GetaddressinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
        ];
    ...
    async fn getbalance(&self, _dummy: Option<String>, _minconf: Option<u32>, _include_watchonly: Option<bool>, _avoid_reuse: Option<bool>) -> Result<GetbalanceResponse, TransportError> {
        let params = vec![
    ...
    async fn getblock(&self, _blockhash: bitcoin::BlockHash, _verbosity: Option<f64>) -> Result<GetblockResponse, TransportError> {
        let params = vec![
    ...
    async fn getblockfilter(&self, _blockhash: bitcoin::BlockHash, _filtertype: Option<String>) -> Result<GetblockfilterResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
    ...
    async fn getblockfrompeer(&self, _blockhash: bitcoin::BlockHash, _peer_id: f64) -> Result<GetblockfrompeerResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
    ...
    async fn getblockheader(&self, _blockhash: bitcoin::BlockHash, _verbose: Option<bool>) -> Result<GetblockheaderResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
    ...
    async fn getblockstats(&self, _hash_or_height: u64, _stats: Option<Vec<serde_json::Value>>) -> Result<GetblockstatsResponse, TransportError> {
        let params = vec![
    ...
    async fn getblocktemplate(&self, _template_request: serde_json::Value) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_template_request),
        ];
    ...
    async fn getchaintxstats(&self, _nblocks: Option<u64>, _blockhash: Option<bitcoin::BlockHash>) -> Result<GetchaintxstatsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_nblocks),
            serde_json::json!(_blockhash),
        ];
    ...
    async fn getdeploymentinfo(&self, _blockhash: Option<bitcoin::BlockHash>) -> Result<GetdeploymentinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
        ];
    ...
    async fn getdescriptorinfo(&self, _descriptor: String) -> Result<GetdescriptorinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_descriptor),
        ];
    ...
    async fn gethdkeys(&self, _options: Option<serde_json::Value>) -> Result<GethdkeysResponse, TransportError> {
        let params = vec![
            serde_json::json!(_options),
        ];
    ...
    async fn getindexinfo(&self, _index_name: Option<String>) -> Result<GetindexinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_index_name),
        ];
        self.dispatch_json::<GetindexinfoResponse>("getindexinfo", &params).await
    }

    /// Returns an object containing information about memory usage.
    async fn getmemoryinfo(&self, _mode: Option<String>) -> Result<GetmemoryinfoResponse, TransportError> {
        let params = vec![
            serde_json::json!(_mode),
        ];
        self.dispatch_json::<GetmemoryinfoResponse>("getmemoryinfo", &params).await
    }

    /// If txid is in the mempool, returns all in-mempool ancestors.
    async fn getmempoolancestors(&self, _txid: bitcoin::Txid, _verbose: Option<bool>) -> Result<GetmempoolancestorsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_verbose),
        ];
    ...
    async fn getmempooldescendants(&self, _txid: bitcoin::Txid, _verbose: Option<bool>) -> Result<GetmempooldescendantsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_verbose),
        ];
    ...
    async fn getmempoolentry(&self, _txid: bitcoin::Txid) -> Result<GetmempoolentryResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
        ];
    ...
    async fn getnetworkhashps(&self, _nblocks: Option<u64>, _height: Option<u64>) -> Result<GetnetworkhashpsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_nblocks),
            serde_json::json!(_height),
        ];
    ...
    async fn getnewaddress(&self, _label: Option<String>, _address_type: Option<String>) -> Result<GetnewaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_label),
            serde_json::json!(_address_type),
        ];
    ...
    async fn getnodeaddresses(&self, _count: Option<u64>, _network: Option<String>) -> Result<GetnodeaddressesResponse, TransportError> {
        let params = vec![
            serde_json::json!(_count),
            serde_json::json!(_network),
        ];
    ...
    async fn getorphantxs(&self, _verbosity: Option<f64>) -> Result<GetorphantxsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_verbosity),
        ];
    ...
    async fn getprioritisedtransactions(&self) -> Result<GetprioritisedtransactionsResponse, TransportError> {
        let params = vec![

        ];
        self.dispatch_json::<GetprioritisedtransactionsResponse>("getprioritisedtransactions", &params).await
    }
    ...
    async fn getrawchangeaddress(&self, _address_type: Option<String>) -> Result<GetrawchangeaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address_type),
        ];
    ...
    async fn getrawmempool(&self, _verbose: Option<bool>, _mempool_sequence: Option<bool>) -> Result<GetrawmempoolResponse, TransportError> {
        let params = vec![
            serde_json::json!(_verbose),
    ...
    async fn getrawtransaction(&self, _txid: bitcoin::Txid, _verbosity: Option<f64>, _blockhash: Option<bitcoin::BlockHash>) -> Result<GetrawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_verbosity),
            serde_json::json!(_blockhash),
    ...
    async fn getreceivedbyaddress(&self, _address: String, _minconf: Option<u32>, _include_immature_coinbase: Option<bool>) -> Result<GetreceivedbyaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
            serde_json::json!(_minconf),
    ...
    async fn getreceivedbylabel(&self, _label: String, _minconf: Option<u32>, _include_immature_coinbase: Option<bool>) -> Result<GetreceivedbylabelResponse, TransportError> {
        let params = vec![
            serde_json::json!(_label),
            serde_json::json!(_minconf),
            serde_json::json!(_include_immature_coinbase),
    ...
    async fn gettransaction(&self, _txid: String, _include_watchonly: Option<bool>, _verbose: Option<bool>) -> Result<GettransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_include_watchonly),
            serde_json::json!(_verbose),
    ...
    async fn gettxout(&self, _txid: String, _n: f64, _include_mempool: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_n),
    ...
    async fn gettxoutproof(&self, _txids: Vec<serde_json::Value>, _blockhash: Option<bitcoin::BlockHash>) -> Result<GettxoutproofResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txids),
            serde_json::json!(_blockhash),
        ];
    ...
    async fn gettxoutsetinfo(&self, _hash_type: Option<String>, _hash_or_height: Option<u64>, _use_index: Option<bool>) -> Result<GettxoutsetinfoResponse, TransportError> {
        let params = vec![
    ...
    async fn gettxspendingprevout(&self, _outputs: Vec<serde_json::Value>) -> Result<GettxspendingprevoutResponse, TransportError> {
        let params = vec![
            serde_json::json!(_outputs),
        ];
    ...
    async fn getunconfirmedbalance(&self) -> Result<GetunconfirmedbalanceResponse, TransportError> {
        let params = vec![

        ];
        self.dispatch_json::<GetunconfirmedbalanceResponse>("getunconfirmedbalance", &params).await
    }
    ...
    async fn importaddress(&self, _address: String, _label: Option<String>, _rescan: Option<bool>, _p2sh: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_address),
            serde_json::json!(_label),
            serde_json::json!(_rescan),
            serde_json::json!(_p2sh),
        ];
        self.dispatch_json::<()>("importaddress", &params).await
    }
    ...
    async fn importdescriptors(&self, _requests: Vec<serde_json::Value>) -> Result<ImportdescriptorsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_requests),
        ];
    ...
    async fn importmempool(&self, _filepath: String, _options: Option<serde_json::Value>) -> Result<ImportmempoolResponse, TransportError> {
        let params = vec![
            serde_json::json!(_filepath),
            serde_json::json!(_options),
        ];
    ...
    /// Note: Use "getwalletinfo" to query the scanning progress.
    /// Note: This command is only compatible with legacy wallets. Use "importdescriptors" for descriptor wallets.
    async fn importmulti(&self, _requests: Vec<serde_json::Value>, _options: Option<serde_json::Value>) -> Result<ImportmultiResponse, TransportError> {
        let params = vec![
            serde_json::json!(_requests),
            serde_json::json!(_options),
        ];
        self.dispatch_json::<ImportmultiResponse>("importmulti", &params).await
    }
    ...
    async fn importprivkey(&self, _privkey: String, _label: Option<String>, _rescan: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_privkey),
            serde_json::json!(_label),
            serde_json::json!(_rescan),
        ];
        self.dispatch_json::<()>("importprivkey", &params).await
    }

    /// Imports funds without rescan. Corresponding address or script must previously be included in wallet. Aimed towards pruned wallets. The end-user is responsible to import additional transactions that subsequently spend the imported outputs or rescan after the point in the blockchain the transaction is included.
    async fn importprunedfunds(&self, _rawtransaction: String, _txoutproof: String) -> Result<(), TransportError> {
        let params = vec![
    ...
    /// Note: Use "getwalletinfo" to query the scanning progress.
    /// Note: This command is only compatible with legacy wallets. Use "importdescriptors" with "combo(X)" for descriptor wallets.
    async fn importpubkey(&self, _pubkey: String, _label: Option<String>, _rescan: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_pubkey),
            serde_json::json!(_label),
            serde_json::json!(_rescan),
        ];
        self.dispatch_json::<()>("importpubkey", &params).await
    }

    /// Imports keys from a wallet dump file (see dumpwallet). Requires a new wallet backup to include imported keys.
    /// Note: Blockchain and Mempool will be rescanned after a successful import. Use "getwalletinfo" to query the scanning progress.
    /// Note: This command is only compatible with legacy wallets.
    async fn importwallet(&self, _filename: String) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_filename),
        ];
        self.dispatch_json::<()>("importwallet", &params).await
    }
    ...
    async fn joinpsbts(&self, _txs: Vec<serde_json::Value>) -> Result<JoinpsbtsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txs),
        ];
    ...
    async fn listdescriptors(&self, _private: Option<bool>) -> Result<ListdescriptorsResponse, TransportError> {
        let params = vec![
    ...
    async fn listlabels(&self, _purpose: Option<String>) -> Result<ListlabelsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_purpose),
        ];
    ...
    async fn listreceivedbyaddress(&self, _minconf: Option<u32>, _include_empty: Option<bool>, _include_watchonly: Option<bool>, _address_filter: Option<String>, _include_immature_coinbase: Option<bool>) -> Result<ListreceivedbyaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_minconf),
    ...
    async fn listreceivedbylabel(&self, _minconf: Option<u32>, _include_empty: Option<bool>, _include_watchonly: Option<bool>, _include_immature_coinbase: Option<bool>) -> Result<ListreceivedbylabelResponse, TransportError> {
        let params = vec![
            serde_json::json!(_minconf),
            serde_json::json!(_include_empty),
            serde_json::json!(_include_watchonly),
    ...
    async fn listsinceblock(&self, _blockhash: Option<String>, _target_confirmations: Option<f64>, _include_watchonly: Option<bool>, _include_removed: Option<bool>, _include_change: Option<bool>, _label: Option<String>) -> Result<ListsinceblockResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
    ...
    async fn listtransactions(&self, _label: Option<String>, _count: Option<u64>, _skip: Option<f64>, _include_watchonly: Option<bool>) -> Result<ListtransactionsResponse, TransportError> {
        let params = vec![
            serde_json::json!(_label),
            serde_json::json!(_count),
    ...
    async fn listunspent(&self, _minconf: Option<u32>, _maxconf: Option<f64>, _addresses: Option<Vec<bitcoin::Address<bitcoin::address::NetworkUnchecked>>>, _include_unsafe: Option<bool>, _query_options: Option<serde_json::Value>) -> Result<ListunspentResponse, TransportError> {
        let params = vec![
            serde_json::json!(_minconf),
    ...
    async fn loadwallet(&self, _filename: String, _load_on_startup: Option<bool>) -> Result<LoadwalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_filename),
            serde_json::json!(_load_on_startup),
        ];
    ...
    async fn lockunspent(&self, _unlock: bool, _transactions: Option<Vec<serde_json::Value>>, _persistent: Option<bool>) -> Result<LockunspentResponse, TransportError> {
        let params = vec![
    ...
    async fn logging(&self, _include: Option<Vec<serde_json::Value>>, _exclude: Option<Vec<serde_json::Value>>) -> Result<LoggingResponse, TransportError> {
        let params = vec![
            serde_json::json!(_include),
            serde_json::json!(_exclude),
        ];
    ...
    async fn migratewallet(&self, _wallet_name: Option<String>, _passphrase: Option<String>) -> Result<MigratewalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_wallet_name),
            serde_json::json!(_passphrase),
        ];
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn newkeypool(&self) -> Result<(), TransportError> {
        let params = vec![

        ];
        self.dispatch_json::<()>("newkeypool", &params).await
    }
    ...
    async fn prioritisetransaction(&self, _txid: bitcoin::Txid, _dummy: Option<f64>, _fee_delta: f64) -> Result<PrioritisetransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_dummy),
    ...
    async fn pruneblockchain(&self, _height: u64) -> Result<PruneblockchainResponse, TransportError> {
        let params = vec![
            serde_json::json!(_height),
        ];
    ...
    /// returned by getnetworkinfo) to enter the node's mempool.
    /// * WARNING: before version 0.21, fee_rate was in BTC/kvB. As of 0.21, fee_rate is in sat/vB. *
    async fn psbtbumpfee(&self, _txid: bitcoin::Txid, _options: Option<serde_json::Value>) -> Result<PsbtbumpfeeResponse, TransportError> {
        let params = vec![
            serde_json::json!(_txid),
            serde_json::json!(_options),
        ];
    ...
    async fn rescanblockchain(&self, _start_height: Option<u64>, _stop_height: Option<u64>) -> Result<RescanblockchainResponse, TransportError> {
        let params = vec![
    ...
    /// and block filters are available (using startup option "-blockfilterindex=1").
    async fn restorewallet(&self, _wallet_name: String, _backup_file: String, _load_on_startup: Option<bool>) -> Result<RestorewalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_wallet_name),
    ...
    /// This call may take several minutes. Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
    async fn scanblocks(&self, _action: String, _scanobjects: Option<Vec<serde_json::Value>>, _start_height: Option<u64>, _stop_height: Option<u64>, _filtertype: Option<String>, _options: Option<serde_json::Value>) -> Result<(), TransportError> {
        let params = vec![
    ...
    /// For more information on output descriptors, see the documentation in the doc/descriptors.md file.
    async fn scantxoutset(&self, _action: String, _scanobjects: Option<Vec<serde_json::Value>>) -> Result<ScantxoutsetResponse, TransportError> {
        let params = vec![
            serde_json::json!(_action),
            serde_json::json!(_scanobjects),
        ];
    ...
    /// 
    /// Send a transaction.
    async fn send(&self, _outputs: Vec<serde_json::Value>, _conf_target: Option<u64>, _estimate_mode: Option<String>, _fee_rate: Option<serde_json::Value>, _options: Option<serde_json::Value>) -> Result<SendResponse, TransportError> {
        let params = vec![
            serde_json::json!(_outputs),
            serde_json::json!(_conf_target),
            serde_json::json!(_estimate_mode),
    ...
    async fn sendall(&self, _recipients: Vec<serde_json::Value>, _conf_target: Option<u64>, _estimate_mode: Option<String>, _fee_rate: Option<serde_json::Value>, _options: Option<serde_json::Value>) -> Result<SendallResponse, TransportError> {
        let params = vec![
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn sendmany(&self, _dummy: Option<String>, _amounts: serde_json::Value, _minconf: Option<u32>, _comment: Option<String>, _subtractfeefrom: Option<Vec<serde_json::Value>>, _replaceable: Option<bool>, _conf_target: Option<u64>, _estimate_mode: Option<String>, _fee_rate: Option<serde_json::Value>, _verbose: Option<bool>) -> Result<SendmanyResponse, TransportError> {
        let params = vec![
            serde_json::json!(_dummy),
    ...
    async fn sendmsgtopeer(&self, _peer_id: f64, _msg_type: String, _msg: String) -> Result<SendmsgtopeerResponse, TransportError> {
        let params = vec![
            serde_json::json!(_peer_id),
    ...
    async fn sendrawtransaction(&self, _hexstring: String, _maxfeerate: Option<serde_json::Value>, _maxburnamount: Option<serde_json::Value>) -> Result<SendrawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn sendtoaddress(&self, _address: String, _amount: serde_json::Value, _comment: Option<String>, _comment_to: Option<String>, _subtractfeefromamount: Option<bool>, _replaceable: Option<bool>, _conf_target: Option<u64>, _estimate_mode: Option<String>, _avoid_reuse: Option<bool>, _fee_rate: Option<serde_json::Value>, _verbose: Option<bool>) -> Result<SendtoaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
    ...
    async fn setban(&self, _subnet: String, _command: String, _bantime: Option<u64>, _absolute: Option<bool>) -> Result<(), TransportError> {
        let params = vec![
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    /// Note: This command is only compatible with legacy wallets.
    async fn sethdseed(&self, _newkeypool: Option<bool>, _seed: Option<String>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_newkeypool),
            serde_json::json!(_seed),
        ];
        self.dispatch_json::<()>("sethdseed", &params).await
    }
    ...
    async fn setmocktime(&self, _timestamp: u64) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_timestamp),
        ];
        self.dispatch_json::<()>("setmocktime", &params).await
    }

    /// Disable/enable all p2p network activity.
    async fn setnetworkactive(&self, _state: bool) -> Result<SetnetworkactiveResponse, TransportError> {
        let params = vec![
            serde_json::json!(_state),
        ];
    ...
    async fn settxfee(&self, _amount: serde_json::Value) -> Result<SettxfeeResponse, TransportError> {
        let params = vec![
            serde_json::json!(_amount),
        ];
    ...
    async fn setwalletflag(&self, _flag: String, _value: Option<bool>) -> Result<SetwalletflagResponse, TransportError> {
        let params = vec![
            serde_json::json!(_flag),
            serde_json::json!(_value),
        ];
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn signmessage(&self, _address: String, _message: String) -> Result<SignmessageResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
    ...
    /// Sign a message with the private key of an address
    async fn signmessagewithprivkey(&self, _privkey: String, _message: String) -> Result<SignmessagewithprivkeyResponse, TransportError> {
        let params = vec![
            serde_json::json!(_privkey),
            serde_json::json!(_message),
        ];
        self.dispatch_json::<SignmessagewithprivkeyResponse>("signmessagewithprivkey", &params).await
    }
    ...
    async fn signrawtransactionwithkey(&self, _hexstring: String, _privkeys: Vec<serde_json::Value>, _prevtxs: Option<Vec<serde_json::Value>>, _sighashtype: Option<String>) -> Result<SignrawtransactionwithkeyResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
        ...
        self.dispatch_json::<SignrawtransactionwithkeyResponse>("signrawtransactionwithkey", &params).await
    }
    ...
    /// this transaction depends on but may not yet be in the block chain.
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn signrawtransactionwithwallet(&self, _hexstring: String, _prevtxs: Option<Vec<serde_json::Value>>, _sighashtype: Option<String>) -> Result<SignrawtransactionwithwalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_hexstring),
            serde_json::json!(_prevtxs),
            serde_json::json!(_sighashtype),
        ];
        self.dispatch_json::<SignrawtransactionwithwalletResponse>("signrawtransactionwithwallet", &params).await
    }

    /// Calculate the balance change resulting in the signing and broadcasting of the given transaction(s).
    async fn simulaterawtransaction(&self, _rawtxs: Option<Vec<serde_json::Value>>, _options: Option<serde_json::Value>) -> Result<SimulaterawtransactionResponse, TransportError> {
        let params = vec![
            serde_json::json!(_rawtxs),
            serde_json::json!(_options),
        ];
        self.dispatch_json::<SimulaterawtransactionResponse>("simulaterawtransaction", &params).await
    }

    /// Request a graceful shutdown of Bitcoin Core.
    async fn stop(&self, _wait: Option<f64>) -> Result<StopResponse, TransportError> {
        let params = vec![
            serde_json::json!(_wait),
        ];
    ...
    async fn submitblock(&self, _hexdata: String, _dummy: Option<String>) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_hexdata),
            serde_json::json!(_dummy),
        ];
    ...
    async fn submitpackage(&self, _package: Vec<serde_json::Value>, _maxfeerate: Option<serde_json::Value>, _maxburnamount: Option<serde_json::Value>) -> Result<SubmitpackageResponse, TransportError> {
        let params = vec![
    ...
    async fn testmempoolaccept(&self, _rawtxs: Vec<serde_json::Value>, _maxfeerate: Option<serde_json::Value>) -> Result<TestmempoolacceptResponse, TransportError> {
        let params = vec![
            serde_json::json!(_rawtxs),
            serde_json::json!(_maxfeerate),
        ];
    ...
    async fn unloadwallet(&self, _wallet_name: Option<String>, _load_on_startup: Option<bool>) -> Result<UnloadwalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_wallet_name),
            serde_json::json!(_load_on_startup),
        ];
    ...
    async fn upgradewallet(&self, _version: Option<u32>) -> Result<UpgradewalletResponse, TransportError> {
        let params = vec![
            serde_json::json!(_version),
        ];
        self.dispatch_json::<UpgradewalletResponse>("upgradewallet", &params).await
    }
    ...
    async fn utxoupdatepsbt(&self, _psbt: String, _descriptors: Option<Vec<serde_json::Value>>) -> Result<UtxoupdatepsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_psbt),
            serde_json::json!(_descriptors),
        ];
    ...
    /// Return information about the given bitcoin address.
    async fn validateaddress(&self, _address: String) -> Result<ValidateaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
        ];
    ...
    async fn verifychain(&self, _checklevel: Option<f64>, _nblocks: Option<u64>) -> Result<VerifychainResponse, TransportError> {
        let params = vec![
            serde_json::json!(_checklevel),
            serde_json::json!(_nblocks),
        ];
    ...
    async fn verifymessage(&self, _address: String, _signature: String, _message: String) -> Result<VerifymessageResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
    ...
    async fn verifytxoutproof(&self, _proof: String) -> Result<VerifytxoutproofResponse, TransportError> {
        let params = vec![
            serde_json::json!(_proof),
        ];
    ...
    async fn waitforblock(&self, _blockhash: bitcoin::BlockHash, _timeout: Option<u64>) -> Result<WaitforblockResponse, TransportError> {
        let params = vec![
            serde_json::json!(_blockhash),
            serde_json::json!(_timeout),
        ];
    ...
    /// 
    /// Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
    async fn waitforblockheight(&self, _height: u64, _timeout: Option<u64>) -> Result<WaitforblockheightResponse, TransportError> {
        let params = vec![
            serde_json::json!(_height),
            serde_json::json!(_timeout),
        ];
    ...
    /// 
    /// Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
    async fn waitfornewblock(&self, _timeout: Option<u64>) -> Result<WaitfornewblockResponse, TransportError> {
        let params = vec![
            serde_json::json!(_timeout),
        ];
    ...
    /// All existing inputs must either have their previous output transaction be in the wallet
    /// or be in the UTXO set. Solving data must be provided for non-wallet inputs.
    async fn walletcreatefundedpsbt(&self, _inputs: Option<Vec<serde_json::Value>>, _outputs: Vec<serde_json::Value>, _locktime: Option<u64>, _options: Option<serde_json::Value>, _bip32derivs: Option<bool>) -> Result<WalletcreatefundedpsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_inputs),
            serde_json::json!(_outputs),
            serde_json::json!(_locktime),
        ...
        self.dispatch_json::<WalletcreatefundedpsbtResponse>("walletcreatefundedpsbt", &params).await
    }

    /// Display address on an external signer for verification.
    async fn walletdisplayaddress(&self, _address: String) -> Result<WalletdisplayaddressResponse, TransportError> {
        let params = vec![
            serde_json::json!(_address),
        ];
    ...
    async fn walletpassphrase(&self, _passphrase: String, _timeout: u64) -> Result<(), TransportError> {
        let params = vec![
            serde_json::json!(_passphrase),
            serde_json::json!(_timeout),
        ];
    ...
    async fn walletpassphrasechange(&self, _oldpassphrase: String, _newpassphrase: String) -> Result<(), TransportError> {
        let params = vec![
    ...
    /// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
    async fn walletprocesspsbt(&self, _psbt: String, _sign: Option<bool>, _sighashtype: Option<String>, _bip32derivs: Option<bool>, _finalize: Option<bool>) -> Result<WalletprocesspsbtResponse, TransportError> {
        let params = vec![
            serde_json::json!(_psbt),
...
#[async_trait]
impl<T: TransportTrait + TransportExt + Send + Sync> BitcoinClientV012 for T {
    /// Mark in-wallet transaction <txid> as abandoned
    /// This will mark this transaction and all its in-wallet descendants as abandoned which will allow
    /// for their inputs to be respent.  It can be used to replace "stuck" or evicted transactions.
    /// It only works on transactions which are not included in a block and are not currently in the mempool.
